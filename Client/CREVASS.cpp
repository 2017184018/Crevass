...
void CREVASS::Startup(void)
{
	...
	// Particles
	m_MeshRef->BuildParticle(g_Device.Get(), g_CommandList.Get(), "testParticle", 1000, DirectX::XMFLOAT2(5, 5),30.f,70.f,100.f,70.f, DirectX::XMFLOAT2(0, 0), DirectX::XMFLOAT2(1, 5));
