...
{
public:
	enum CHANNEL_ID { BGM,SELECT_BUTTON, SELECT_OK, PLAYER_RUNNING, PLAYER_JUMP, PLAYER_ATTACK, PLAYER_OVERlAP, PLAYER_ATTACKED, PLAYER_FALL,
		PENGUIN_SKILL, HUSKY_SKILL, FOX_SKILL, SEAL_SKILL, PLAYER_WIN, PLAYER_LOSE, MAX_CHANNEL
