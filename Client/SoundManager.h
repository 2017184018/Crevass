...
{
public:
	enum CHANNEL_ID { BGM, PLAYER_RUNNING, PLAYER_JUMP, PLAYER_ATTACK, PLAYER_OVERlAP, PLAYER_ATTACKED, PLAYER_FALL, PENGUIN_SKILL, MAX_CHANNEL, ICE_BRAKING1, ICE_BRAKING2
